...
pagerun.loadPlugin = function(pluginName, bNpm){
    ...
    pluginEnv.error = function(message){
        return pagerun.result('error', pluginName, message);
    };
    pluginEnv.warn = function(message){
        return pagerun.result('warn', pluginName, message);
    };
    pluginEnv.info = function(message){
        return pagerun.result('info', pluginName, message);
    };
...
// save result
pagerun.result = function(type, module, message){
    arrResults.push({
        type: type,
        module: module,
        message: message,
