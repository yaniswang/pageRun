    ...
    pagerun.on('proxyStart', function(msg){
        ...
        proxy.addFilter(function(httpData, next, end){
            ...
            if(httpData.responseCode === 200 &&
                ...
                httpData.responseContent = responseContent.replace(/<head(\s+[^<>]*)?>/i, '$&<script type="text/javascript" src="http://pagerun/json.js" charset="utf-8"></script><script type="text/javascript" src="http://pagerun/bridge.js" charset="utf-8"></script>');
            }
