(function(win, undefined){
    ...
    pagerun.error = function(module, message){
        saveResult('error', module, message);
    }

    // save warn
    pagerun.warn = function(module, message){
        saveResult('warn', module, message);
    }

    // save info
    pagerun.info = function(module, message){
        saveResult('info', module, message);
    }

    // save result
    function saveResult(type, module, message){
        arrResults.push({
            type: type,
    ...
    pagerun.getResult = function(isToString){
        return isToString?JSON.stringify(arrResults):arrResults;
    };
